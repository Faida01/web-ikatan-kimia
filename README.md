...
<body>
    <div class="container">
        <nav>
            ...
            <button onclick="showPage('tujuan')">🎯 Tujuan</button>
            <button onclick="showPage('materi')">📚 Materi</button>
            <button onclick="showPage('simulasi')">🔬 Simulasi</button>
        ...
        <div id="materi" class="content">
            ...
            <div class="materi-box">
                ...
                <h3>Contoh</h3>
                <p>NaCl: Natrium (Na) melepas 1 elektron menjadi Na⁺, Klorin (Cl) menerima 1 elektron menjadi Cl⁻</p>
            ...
            <div class="materi-box">
                ...
                <ul>
                    ...
                    <li><strong>Kovalen Rangkap Dua:</strong> 2 pasang elektron bersama (O₂, CO₂)</li>
                    <li><strong>Kovalen Rangkap Tiga:</strong> 3 pasang elektron bersama (N₂, C₂H₂)</li>
                </ul>
        ...
        <div id="simulasi" class="content">
            <h1>🔬 Virtual Lab - Simulasi Ikatan Kimia</h1>
            ...
            <div class="virtual-lab" id="virtualLab" style="display: none;">
                ...
                <div class="control-panel">
                    <button class="control-btn" onclick="playAnimation()">▶️ Jalankan</button>
        ...
        <div id="quiz" class="content">
            ...
            <div class="quiz-question">
                ...
                <div class="quiz-options">
                    ...
                    <div class="quiz-option" data-question="2" data-answer="b">B. H₂O</div>
                    <div class="quiz-option" data-question="2" data-answer="c">C. CaO</div>
                    <div class="quiz-option" data-question="2" data-answer="d">D. MgCl₂</div>
                </div>
            </div>
            ...
            <div class="quiz-question">
                <h3>Soal 4</h3>
                <p>Molekul N₂ memiliki ikatan kovalen...</p>
                <div class="quiz-options">
    ...
    <script>
        ...
        function submitQuiz() {
            ...
            resultDiv.innerHTML = `
                ...
                <p>${percentage >= 80 ? '🎉 Luar biasa!' : percentage >= 60 ? '👍 Bagus!' : '💪 Terus belajar!'}</p>
            `;
        ...
        function startIonicSim() {
            ...
            document.getElementById('labTitle').textContent = '⚡ Simulasi Ikatan Ionik: Na + Cl → NaCl';
            document.getElementById('infoText').innerHTML = `
                <strong>Tahap 1:</strong> Atom Na dan Cl terpisah<br>
                <strong>Tahap 2:</strong> Na melepas elektron (menjadi Na⁺)<br>
                <strong>Tahap 3:</strong> Cl menerima elektron (menjadi Cl⁻)<br>
        ...
        function startCovalentSim() {
            ...
            document.getElementById('virtualLab').style.display = 'block';
            document.getElementById('labTitle').textContent = '🔗 Simulasi Ikatan Kovalen: H + H → H₂';
            document.getElementById('infoText').innerHTML = `
        ...
        function startWaterSim() {
            ...
            document.getElementById('virtualLab').style.display = 'block';
            document.getElementById('labTitle').textContent = '💧 Simulasi Molekul Air: 2H + O → H₂O';
            document.getElementById('infoText').innerHTML = `
                ...
                <strong>Tahap 4:</strong> Molekul H₂O terbentuk (sudut 104.5°)
            `;
            resetAnimation();
            document.getElementById('virtualLab').scrollIntoView({ behavior: 'smooth' });
        }
